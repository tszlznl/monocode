      ...
      >
        <div className="flex min-w-0 items-center gap-2">
          {many ? (
            <button
              type="button"
              title={expanded ? t("sessionReview.collapseFiles") : t("sessionReview.expandFiles")}
            ...
            >
              ...
              <span className="truncate text-[12px]">
                {t("sessionReview.filesCount", { count: files.length })}
              </span>
            </button>
          ) : (
            <FileLabel
          ...
          <div className="flex shrink-0 items-center gap-0.5">
            <button
              ...
              title={
                canUndoAll
                  ? t("sessionReview.undoAllTitle")
                  : undoLocked
                    ? t("sessionReview.undoUnavailableRunning")
            ...
            >
              {t("sessionReview.undoAll")}
            </button>
            <button
              type="button"
              title={t("sessionReview.keepAllTitle")}
              disabled={disabled}
              onClick={() => run("keep")}
              className="h-6 rounded-md px-1.5  text-[11px] text-content/55 hover:bg-content/10 hover:text-content disabled:opacity-40"
            >
              {t("sessionReview.keepAll")}
            </button>
            <button
              type="button"
