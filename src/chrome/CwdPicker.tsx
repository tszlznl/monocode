  ...
  return (
    ...
    >
      <button
        type="button"
        title={cwd}
        aria-label={t("cwdPicker.projectLabel", { name: label })}
        aria-expanded={open}
        aria-haspopup="menu"
        disabled={!enabled}
        ...
        >
          ...
          >
            ...
            {hasMore ? (
              ...
              >
                <span className="text-[13px]">{t("cwdPicker.moreRecents")}</span>
                <ChevronRight
          ...
          {onNewTerminal ? (
            <div className="shrink-0 border-t border-content/10 py-1">
              ...
              >
                <span className="text-[13px]">{t("cwdPicker.newTerminal")}</span>
      ...
      {open && moreOpen ? (
        <Popover
          ...
          layer={LAYER.submenu}
          role="menu"
          aria-label={t("cwdPicker.moreRecents")}
          data-cwd-submenu
